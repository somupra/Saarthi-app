...
class ApprovedComplaints extends StatefulWidget {
  @override
  _ApprovedComplaintsState createState() => _ApprovedComplaintsState();
}

class _ApprovedComplaintsState extends State<ApprovedComplaints> {

  // API endpoint
  final url = "http://172.17.73.99:8000/api/complaints/verified";
  ...
  Future<void>fetchData() async {
    ...
    await getToken().then((result) {
      token = result;
      print("Token extracted successfully for approve apis: $token");
    });
